...
static u8 TranslateWeatherNum(u8 weather)
{
    ...
    case WEATHER_RUTA119_CYCLE:     return sWeatherCycleRoute119[gSaveBlock1Ptr->weatherCycleStage];
    case WEATHER_RUTA123_CYCLE:     return sWeatherCycleRoute123[gSaveBlock1Ptr->weatherCycleStage];
