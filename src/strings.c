...
const u8 gText_MainMenuNewGame[] = _("NOVA PARTIDA");
...
const u8 gText_UnkHeight[] = _("{CLEAR_TO 0x0C}???? cm");
...
const u8 gText_SizeComparedTo[] = _("Mida comparada amb tu.");
const u8 gText_PokedexRegistration[] = _("POKéDEX registration completed.");
const u8 gText_HTHeight[] = _("ALÇADA");
...
const u8 gText_WelcomeToHOF[] = _("Welcome to the SALÓ DE L'HONOR!");
const u8 gText_HOFDexRating[] = _("Spotted Pokémon: {STR_VAR_1}!\nOwned Pokémon: {STR_VAR_2}!\pPROF. BIRCH's POKéDEX rating!\pPROF. BIRCH: Let's see…\p");
const u8 gText_HOFDexSaving[] = _("SAVING…\nDON'T TURN OFF THE POWER.");
const u8 gText_HOFCorrupted[] = _("The SALÓ DE L'HONOR data is corrupted.");
const u8 gText_HOFNumber[] = _("SALÓ DE L'HONOR No. {STR_VAR_1}");
...
const u8 gText_Cancel[] = _("ENRERE");
const u8 gText_Cancel2[] = _("ENRERE");
const u8 gMenuText_Show[] = _("SHOW");
const u8 gText_EmptyString2[] = _("");
const u8 gText_Cancel7[] = _("ENRERE"); // Unused
const u8 gText_Item[] = _("OBJECTE");
const u8 gText_Mail[] = _("MAIL");
const u8 gText_Take[] = _("TREURE");
...
const u8 gText_ThrowInPremierBall[] = _("I'll throw in a HONOR BALL, too.{PAUSE_UNTIL_PRESS}");
const u8 gText_CantBuyKeyItem[] = _("{STR_VAR_2}? Oh, no.\nI can't buy that.{PAUSE_UNTIL_PRESS}");
const u8 gText_HowManyToSell[] = _("{STR_VAR_2}?\nHow many would you like to sell?");
const u8 gText_ICanPayVar1[] = _("Puc pagar {STR_VAR_1}¥.\nT'estaria bé?");
...
const u8 gText_PkmnAlreadyHoldingItemSwitch[] = _("{STR_VAR_1} ja té {STR_VAR_2}.\pVols canviar-li l'objecte?");
...
const u8 gText_MoveToWhere[] = _("On vols moure aquest {PKMN}?");
...
const u8 gText_DoWhatWithPokemon[] = _("Què vols fer-li?");
...
const u8 gText_DoWhatWithItem[] = _("Què vols fer amb ell?");
...
const u8 gText_DoWhatWithMail[] = _("Què vols fer amb el CORREU?");
...
const u8 gText_AlreadyHoldingOne[] = _("{STR_VAR_1} ja té {STR_VAR_2}.");
...
const u8 gText_NextLv[] = _("SEGÜENT Nv.");
const u8 gText_RibbonsVar1[] = _("RIBBONS: {STR_VAR_1}");
const u8 gText_EmptyString5[] = _("");
const u8 gText_Events[] = _("EVENTS"); // Unused
const u8 gText_Switch[] = _("MOURE");
const u8 gText_PkmnInfo[] = _("Informació {PKMN}");
const u8 gText_PkmnSkills[] = _("Habilitats {PKMN}");
const u8 gText_BattleMoves[] = _("Moviments {PKMN}");
const u8 gText_ContestMoves[] = _("Concursos {PKMN}");
...
const u8 gText_XNatureProbablyMetAt[] = _("Naturalesa {DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}.\nProbablement obtingut\nal {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1} ({DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}).");
...
const u8 gText_HallOfFame[] = _("SALÓ DE L'HONOR");
...
const u8 gText_MenuOptionBag[] = _("BOSSA");
...
const u8 gText_MenuOptionExit[] = _("ENRERE");
...
const u8 gPCText_Take[] = _("TREURE");
const u8 gPCText_Give[] = _("DONAR");
const u8 gPCText_Switch[] = _("MOURE");
const u8 gPCText_Bag[] = _("BOSSA");
...
const u8 gText_Cancel6[] = _("ENRERE");
...
const u8 gText_LikeToQuitQuiz[] = _("Voldries to quit this quiz");
...
const u8 gText_PkmnFainted3[] = _("{STR_VAR_1} ha sobreviscut al verí.\nEl verí s'ha esvaït!\p");
const u8 gText_Marco[] = _("MARCO");
const u8 gText_TrainerCardName[] = _("NOM: ");
const u8 gText_TrainerCardIDNo[] = _("ID Nº");
...
const u8 gText_HallOfFameDebut[] = _("DEBUT AL SALÓ DE L'HONOR  ");
...
const u8 gText_AlreadySavedFile_Chat[] = _("Ja hi ha un fitxer de guardat.\nSegur que vols sobreescriure'l?");
const u8 gText_SavingDontTurnOff_Chat[] = _("DESANT…\nNO APAGUIS LA CONSOLA.");
const u8 gText_PlayerSavedGame_Chat[] = _("{DYNAMIC 0} ha guardat la partida.");
...
const u8 gText_NicknameHatchPrompt[] = _("Voldries to nickname the newly\nhatched {STR_VAR_1}?");
...
const u8 gText_UnusedCancel[] = _("ENRERE"); // Unused
const u8 gText_EmptyString7[] = _("");
const u8 gText_CheckFrontierMap[] = _("Veure mapa del FRONT de BATALLA.");
const u8 gText_CheckTrainerCard[] = _("Veure CARNET D'ENTRENAD.");
const u8 gText_ViewRecordedBattle[] = _("Veure el combat enregistrat.");
const u8 gText_PutAwayFrontierPass[] = _("Desar el PASSI del FRONT.");
const u8 gText_CurrentBattlePoints[] = _("Els punts de batalla que has guanyat.");
const u8 gText_CollectedSymbols[] = _("Els símbols que has guanyat.");
...
const u8 gText_ContinueMenuPlayer[] = _("NOM");
const u8 gText_ContinueMenuTime[] = _("TEMPS J.");
...
const u8 gText_OpenLv[] = _("OPEN NV.");
...
const u8 gText_234Players[] = _("2 JUG.\n3 JUG.\n4 JUG.");
...
const u8 gText_FrameType[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Estil ");
...
const u8 gText_MenuBag[] = _("BOSSA");
...
const u8 gText_MenuExit[] = _("TORNA");
...
const u8 gText_Summary[] = _("VEURE");
...
const u8 gText_Summary2[] = _("VEURE");
...
const u8 gText_Cancel3[] = _("ENRERE");
...
const u8 gText_MoveRelearnerBattleMoves[] = _("Moviments {PKMN}");
...
const u8 gText_Cancel4[] = _("ENRERE");
...
const u8 gText_Cancel5[] = _("ENRERE");
