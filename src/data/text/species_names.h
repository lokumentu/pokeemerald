const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    [SPECIES_NONE] = _("??????????"),
    [SPECIES_BULBASAUR] = _("BULBASUR"),
    [SPECIES_IVYSAUR] = _("IVISUR"),
    [SPECIES_VENUSAUR] = _("VENUSUR"),
    [SPECIES_CHARMANDER] = _("CHARMANDER"),
    [SPECIES_CHARMELEON] = _("CHARMILION"),
    [SPECIES_CHARIZARD] = _("CHARIZAR"),
    [SPECIES_SQUIRTLE] = _("ESQÜIRTEL"),
    [SPECIES_WARTORTLE] = _("GUARTORTEL"),
    [SPECIES_BLASTOISE] = _("BLASTOIS"),
    [SPECIES_CATERPIE] = _("CATERPI"),
    [SPECIES_METAPOD] = _("METAPOT"),
    [SPECIES_BUTTERFREE] = _("BATERFRI"),
    [SPECIES_WEEDLE] = _("GÜIDEL"),
    [SPECIES_KAKUNA] = _("CACUNA"),
    [SPECIES_BEEDRILL] = _("BIDRIL"),
    [SPECIES_PIDGEY] = _("PITGI"),
    [SPECIES_PIDGEOTTO] = _("PITGIOTO"),
    [SPECIES_PIDGEOT] = _("PITGIOT"),
    [SPECIES_RATTATA] = _("RATATA"),
    [SPECIES_RATICATE] = _("RATIQUEIT"),
    [SPECIES_SPEAROW] = _("ESPIROU"),
    [SPECIES_FEAROW] = _("FIROU"),
    [SPECIES_EKANS] = _("ECANS"),
    [SPECIES_ARBOK] = _("ARBOC"),
    [SPECIES_PIKACHU] = _("PICACHU"),
    [SPECIES_RAICHU] = _("RAICHU"),
    [SPECIES_SANDSHREW] = _("SANDRIU"),
    [SPECIES_SANDSLASH] = _("SANDLASH"),
    [SPECIES_NIDORAN_F] = _("NIDORAN♀"),
    [SPECIES_NIDORINA] = _("NIDORINA"),
    [SPECIES_NIDOQUEEN] = _("NIDOQÜIN"),
    [SPECIES_NIDORAN_M] = _("NIDORAN♂"),
    [SPECIES_NIDORINO] = _("NIDORINO"),
    [SPECIES_NIDOKING] = _("NIDOQUIN"),
    [SPECIES_CLEFAIRY] = _("CLEFEIRI"),
    [SPECIES_CLEFABLE] = _("CLEFEIBOL"),
    [SPECIES_VULPIX] = _("VULPIX"),
    [SPECIES_NINETALES] = _("NAINTEILS"),
    [SPECIES_JIGGLYPUFF] = _("JIGLIPUF"),
    [SPECIES_WIGGLYTUFF] = _("GÜIGLITUF"),
    [SPECIES_ZUBAT] = _("ZUBAT"),
    [SPECIES_GOLBAT] = _("GOLBAT"),
    [SPECIES_ODDISH] = _("ODISH"),
    [SPECIES_GLOOM] = _("GLUM"),
    [SPECIES_VILEPLUME] = _("VAILPLUM"),
    [SPECIES_PARAS] = _("PARAS"),
    [SPECIES_PARASECT] = _("PARASEC"),
    [SPECIES_VENONAT] = _("VENONAT"),
    [SPECIES_VENOMOTH] = _("VENOMOT"),
    [SPECIES_DIGLETT] = _("DIGLET"),
    [SPECIES_DUGTRIO] = _("DUCTRIO"),
    [SPECIES_MEOWTH] = _("MIAUZ"),
    [SPECIES_PERSIAN] = _("PERSIAN"),
    [SPECIES_PSYDUCK] = _("SAIDAC"),
    [SPECIES_GOLDUCK] = _("GOLDAC"),
    [SPECIES_MANKEY] = _("MANQUI"),
    [SPECIES_PRIMEAPE] = _("PRAIMEIP"),
    [SPECIES_GROWLITHE] = _("GROULIZ"),
    [SPECIES_ARCANINE] = _("ARCANAIN"),
    [SPECIES_POLIWAG] = _("POLIGUAC"),
    [SPECIES_POLIWHIRL] = _("POLIGÜIL"),
    [SPECIES_POLIWRATH] = _("POLIGRAZ"),
    [SPECIES_ABRA] = _("ABRA"),
    [SPECIES_KADABRA] = _("CADABRA"),
    [SPECIES_ALAKAZAM] = _("ALACAZAM"),
    [SPECIES_MACHOP] = _("MACHOP"),
    [SPECIES_MACHOKE] = _("MACHOC"),
    [SPECIES_MACHAMP] = _("MACHAM"),
    [SPECIES_BELLSPROUT] = _("BELLSPROUT"),
    [SPECIES_WEEPINBELL] = _("GÜIPINBEL"),
    [SPECIES_VICTREEBEL] = _("VICTRIBEL"),
    [SPECIES_TENTACOOL] = _("TENTACUL"),
    [SPECIES_TENTACRUEL] = _("TENTACRUEL"),
    [SPECIES_GEODUDE] = _("GIODUT"),
    [SPECIES_GRAVELER] = _("GRAVELER"),
    [SPECIES_GOLEM] = _("GOLEM"),
    [SPECIES_PONYTA] = _("PONITA"),
    [SPECIES_RAPIDASH] = _("RAPIDASH"),
    [SPECIES_SLOWPOKE] = _("ESLOUPOC"),
    [SPECIES_SLOWBRO] = _("ESLOUBRO"),
    [SPECIES_MAGNEMITE] = _("MAGNEMAIT"),
    [SPECIES_MAGNETON] = _("MAGNETON"),
    [SPECIES_FARFETCHD] = _("FARFECH"),
    [SPECIES_DODUO] = _("DODUO"),
    [SPECIES_DODRIO] = _("DODRIO"),
    [SPECIES_SEEL] = _("SIL"),
    [SPECIES_DEWGONG] = _("DIUONC"),
    [SPECIES_GRIMER] = _("GRIMER"),
    [SPECIES_MUK] = _("MUK"),
    [SPECIES_SHELLDER] = _("XELDER"),
    [SPECIES_CLOYSTER] = _("CLOISTER"),
    [SPECIES_GASTLY] = _("GASLI"),
    [SPECIES_HAUNTER] = _("HAUNTER"),
    [SPECIES_GENGAR] = _("GUENGAR"),
    [SPECIES_ONIX] = _("ONIX"),
    [SPECIES_DROWZEE] = _("DROUSI"),
    [SPECIES_HYPNO] = _("HIPNO"),
    [SPECIES_KRABBY] = _("KRABI"),
    [SPECIES_KINGLER] = _("KINGLER"),
    [SPECIES_VOLTORB] = _("VOLTORP"),
    [SPECIES_ELECTRODE] = _("ELECTROUT"),
    [SPECIES_EXEGGCUTE] = _("EXEKIUT"),
    [SPECIES_EXEGGUTOR] = _("EXECUTOR"),
    [SPECIES_CUBONE] = _("CUBOUN"),
    [SPECIES_MAROWAK] = _("MAROGUAC"),
    [SPECIES_HITMONLEE] = _("HITMONLI"),
    [SPECIES_HITMONCHAN] = _("HITMONCHAN"),
    [SPECIES_LICKITUNG] = _("LIQUITUNC"),
    [SPECIES_KOFFING] = _("COFINC"),
    [SPECIES_WEEZING] = _("GÜIZINC"),
    [SPECIES_RHYHORN] = _("RAIHORN"),
    [SPECIES_RHYDON] = _("RAIDON"),
    [SPECIES_CHANSEY] = _("CHANSI"),
    [SPECIES_TANGELA] = _("TANGELA"),
    [SPECIES_KANGASKHAN] = _("CANGASCAN"),
    [SPECIES_HORSEA] = _("HORSI"),
    [SPECIES_SEADRA] = _("SIDRA"),
    [SPECIES_GOLDEEN] = _("GOLDIN"),
    [SPECIES_SEAKING] = _("SIKIN"),
    [SPECIES_STARYU] = _("ESTARYU"),
    [SPECIES_STARMIE] = _("ESTARMI"),
    [SPECIES_MR_MIME] = _("MISTERMAIM"),
    [SPECIES_SCYTHER] = _("SAIDER"),
    [SPECIES_JYNX] = _("GINX"),
    [SPECIES_ELECTABUZZ] = _("ELECTABUZ"),
    [SPECIES_MAGMAR] = _("MAGMAR"),
    [SPECIES_PINSIR] = _("PINSIR"),
    [SPECIES_TAUROS] = _("TAUROS"),
    [SPECIES_MAGIKARP] = _("MAGICARP"),
    [SPECIES_GYARADOS] = _("GIARADOS"),
    [SPECIES_LAPRAS] = _("LAPRAS"),
    [SPECIES_DITTO] = _("DITO"),
    [SPECIES_EEVEE] = _("IVI"),
    [SPECIES_VAPOREON] = _("VAPORION"),
    [SPECIES_JOLTEON] = _("JOLTION"),
    [SPECIES_FLAREON] = _("FLARION"),
    [SPECIES_PORYGON] = _("PORIGON"),
    [SPECIES_OMANYTE] = _("OMANAIT"),
    [SPECIES_OMASTAR] = _("OMASTAR"),
    [SPECIES_KABUTO] = _("KABUTO"),
    [SPECIES_KABUTOPS] = _("KABUTOPS"),
    [SPECIES_AERODACTYL] = _("AERODACTYL"),
    [SPECIES_SNORLAX] = _("ESNORLAX"),
