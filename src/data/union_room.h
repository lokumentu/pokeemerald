...
ALIGNED(4) const u8 sText_DoSomethingFemale[] = _("Voldries to do something?");
...
ALIGNED(4) const u8 sText_OfferToTradeMon[] = _("There is an offer to trade your\nregistered Nv. {DYNAMIC 0} {DYNAMIC 1}\pin exchange for a\nNv. {DYNAMIC 2} {DYNAMIC 3}.\pWill you accept this trade\noffer?");
...
ALIGNED(4) const u8 sText_AskTrainerToMakeTrade[] = _("Voldries to ask {STR_VAR_1} to\nmake a trade?");
...
ALIGNED(4) const u8 sText_NameWantedOfferLv[] = _("NAME{CLEAR_TO 0x3C}WANTED{CLEAR_TO 0x6E}OFFER{CLEAR_TO 0xC6}NV.");
...
ALIGNED(4) const u8 sText_BattleTowerLv50[] = _("BATTLE TOWER NV. 50");
