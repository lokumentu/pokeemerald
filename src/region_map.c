...
{
    {MAPSEC_UNDERWATER_105,             MAPSEC_RUTA_105},
    {MAPSEC_UNDERWATER_124,             MAPSEC_RUTA_124},
    #ifdef BUGFIX
    {MAPSEC_UNDERWATER_125,             MAPSEC_RUTA_125},
    #else
    {MAPSEC_UNDERWATER_125,             MAPSEC_RUTA_129}, // BUG: Map will incorrectly display the name of Route 129 when diving on Route 125 (for Marine Cave only)
    #endif
    {MAPSEC_UNDERWATER_126,             MAPSEC_RUTA_126},
    {MAPSEC_UNDERWATER_127,             MAPSEC_RUTA_127},
    {MAPSEC_UNDERWATER_128,             MAPSEC_RUTA_128},
    {MAPSEC_UNDERWATER_129,             MAPSEC_RUTA_129},
    {MAPSEC_UNDERWATER_SOOTOPOLIS,      MAPSEC_SOOTOPOLIS_CITY},
    {MAPSEC_UNDERWATER_SEAFLOOR_CAVERN, MAPSEC_RUTA_128},
    {MAPSEC_AQUA_HIDEOUT,               MAPSEC_LILYCOVE_CITY},
    {MAPSEC_AQUA_HIDEOUT_OLD,           MAPSEC_LILYCOVE_CITY},
    {MAPSEC_MAGMA_HIDEOUT,              MAPSEC_RUTA_112},
    {MAPSEC_UNDERWATER_SEALED_CHAMBER,  MAPSEC_RUTA_134},
    {MAPSEC_PETALBURG_WOODS,            MAPSEC_RUTA_104},
    {MAPSEC_JAGGED_PASS,                MAPSEC_RUTA_112},
    {MAPSEC_MT_PYRE,                    MAPSEC_RUTA_122},
    {MAPSEC_SKY_PILLAR,                 MAPSEC_RUTA_131},
    {MAPSEC_MIRAGE_TOWER,               MAPSEC_RUTA_111},
    {MAPSEC_TRAINER_HILL,               MAPSEC_RUTA_111},
    {MAPSEC_DESERT_UNDERPASS,           MAPSEC_RUTA_114},
    {MAPSEC_ALTERING_CAVE,              MAPSEC_RUTA_103},
    {MAPSEC_ARTISAN_CAVE,               MAPSEC_RUTA_103},
    {MAPSEC_ABANDONED_SHIP,             MAPSEC_RUTA_108},
...
{
    [ABNORMAL_WEATHER_RUTA_114_NORTH - 1] = MAPSEC_RUTA_114,
    [ABNORMAL_WEATHER_RUTA_114_SOUTH - 1] = MAPSEC_RUTA_114,
    [ABNORMAL_WEATHER_RUTA_115_WEST  - 1] = MAPSEC_RUTA_115,
    [ABNORMAL_WEATHER_RUTA_115_EAST  - 1] = MAPSEC_RUTA_115,
    [ABNORMAL_WEATHER_RUTA_116_NORTH - 1] = MAPSEC_RUTA_116,
    [ABNORMAL_WEATHER_RUTA_116_SOUTH - 1] = MAPSEC_RUTA_116,
    [ABNORMAL_WEATHER_RUTA_118_EAST  - 1] = MAPSEC_RUTA_118,
    [ABNORMAL_WEATHER_RUTA_118_WEST  - 1] = MAPSEC_RUTA_118,
    [ABNORMAL_WEATHER_RUTA_105_NORTH - 1] = MAPSEC_RUTA_105,
    [ABNORMAL_WEATHER_RUTA_105_SOUTH - 1] = MAPSEC_RUTA_105,
    [ABNORMAL_WEATHER_RUTA_125_WEST  - 1] = MAPSEC_RUTA_125,
    [ABNORMAL_WEATHER_RUTA_125_EAST  - 1] = MAPSEC_RUTA_125,
    [ABNORMAL_WEATHER_RUTA_127_NORTH - 1] = MAPSEC_RUTA_127,
    [ABNORMAL_WEATHER_RUTA_127_SOUTH - 1] = MAPSEC_RUTA_127,
    [ABNORMAL_WEATHER_RUTA_129_WEST  - 1] = MAPSEC_RUTA_129,
    [ABNORMAL_WEATHER_RUTA_129_EAST  - 1] = MAPSEC_RUTA_129
};
...
{
    [MARINE_CAVE_COORD(RUTA_105_NORTH)] = {0, 10},
    [MARINE_CAVE_COORD(RUTA_105_SOUTH)] = {0, 12},
    [MARINE_CAVE_COORD(RUTA_125_WEST)]  = {24, 3},
    [MARINE_CAVE_COORD(RUTA_125_EAST)]  = {25, 4},
    [MARINE_CAVE_COORD(RUTA_127_NORTH)] = {25, 6},
    [MARINE_CAVE_COORD(RUTA_127_SOUTH)] = {25, 7},
    [MARINE_CAVE_COORD(RUTA_129_WEST)]  = {24, 10},
    [MARINE_CAVE_COORD(RUTA_129_EAST)]  = {24, 10}
};
...
static const u8 sMapHealLocations[][3] =
{
    ...
    {MAP_GROUP(RUTA101), MAP_NUM(RUTA101), 0},
    {MAP_GROUP(RUTA102), MAP_NUM(RUTA102), 0},
    {MAP_GROUP(RUTA103), MAP_NUM(RUTA103), 0},
    {MAP_GROUP(RUTA104), MAP_NUM(RUTA104), 0},
    {MAP_GROUP(RUTA105), MAP_NUM(RUTA105), 0},
    {MAP_GROUP(RUTA106), MAP_NUM(RUTA106), 0},
    {MAP_GROUP(RUTA107), MAP_NUM(RUTA107), 0},
    {MAP_GROUP(RUTA108), MAP_NUM(RUTA108), 0},
    {MAP_GROUP(RUTA109), MAP_NUM(RUTA109), 0},
    {MAP_GROUP(RUTA110), MAP_NUM(RUTA110), 0},
    {MAP_GROUP(RUTA111), MAP_NUM(RUTA111), 0},
    {MAP_GROUP(RUTA112), MAP_NUM(RUTA112), 0},
    {MAP_GROUP(RUTA113), MAP_NUM(RUTA113), 0},
    {MAP_GROUP(RUTA114), MAP_NUM(RUTA114), 0},
    {MAP_GROUP(RUTA115), MAP_NUM(RUTA115), 0},
    {MAP_GROUP(RUTA116), MAP_NUM(RUTA116), 0},
    {MAP_GROUP(RUTA117), MAP_NUM(RUTA117), 0},
    {MAP_GROUP(RUTA118), MAP_NUM(RUTA118), 0},
    {MAP_GROUP(RUTA119), MAP_NUM(RUTA119), 0},
    {MAP_GROUP(RUTA120), MAP_NUM(RUTA120), 0},
    {MAP_GROUP(RUTA121), MAP_NUM(RUTA121), 0},
    {MAP_GROUP(RUTA122), MAP_NUM(RUTA122), 0},
    {MAP_GROUP(RUTA123), MAP_NUM(RUTA123), 0},
    {MAP_GROUP(RUTA124), MAP_NUM(RUTA124), 0},
    {MAP_GROUP(RUTA125), MAP_NUM(RUTA125), 0},
    {MAP_GROUP(RUTA126), MAP_NUM(RUTA126), 0},
    {MAP_GROUP(RUTA127), MAP_NUM(RUTA127), 0},
    {MAP_GROUP(RUTA128), MAP_NUM(RUTA128), 0},
    {MAP_GROUP(RUTA129), MAP_NUM(RUTA129), 0},
    {MAP_GROUP(RUTA130), MAP_NUM(RUTA130), 0},
    {MAP_GROUP(RUTA131), MAP_NUM(RUTA131), 0},
    {MAP_GROUP(RUTA132), MAP_NUM(RUTA132), 0},
    {MAP_GROUP(RUTA133), MAP_NUM(RUTA133), 0},
    {MAP_GROUP(RUTA134), MAP_NUM(RUTA134), 0}
};
...
static void InitMapBasedOnPlayerLocation(void)
{
    ...
    {
    case MAPSEC_RUTA_114:
        if (y != 0)
            x = 0;
        break;
    case MAPSEC_RUTA_126:
...
static void RegionMap_InitializeStateBasedOnSSTidalLocation(void)
{
    ...
    case SS_TIDAL_LOCATION_LILYCOVE:
        ...
        break;
    case SS_TIDAL_LOCATION_RUTA124:
        gRegionMap->mapSecId = MAPSEC_RUTA_124;
        break;
    case SS_TIDAL_LOCATION_RUTA131:
        gRegionMap->mapSecId = MAPSEC_RUTA_131;
        break;
    default:
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_SOUTHERN_ISLAND:
        return FlagGet(FLAG_LANDMARK_SOUTHERN_ISLAND) ? MAPSECTYPE_RUTA : MAPSECTYPE_NONE;
    default:
        return MAPSECTYPE_RUTA;
    }
}
