...
static const u8 sTileBitAttributes[] =
{
    ...
    [MB_RUTA120_NORTH_BRIDGE_1] = TILE_ATTRIBUTES(TRUE, FALSE, FALSE),
    [MB_RUTA120_NORTH_BRIDGE_2] = TILE_ATTRIBUTES(TRUE, FALSE, FALSE),
    ...
    [MB_RUTA120_SOUTH_BRIDGE_1] = TILE_ATTRIBUTES(TRUE, FALSE, FALSE),
    [MB_RUTA120_SOUTH_BRIDGE_2] = TILE_ATTRIBUTES(TRUE, FALSE, FALSE),
    [MB_RUTA120_NORTH_BRIDGE_3] = TILE_ATTRIBUTES(TRUE, FALSE, FALSE),
    [MB_RUTA120_NORTH_BRIDGE_4] = TILE_ATTRIBUTES(TRUE, FALSE, FALSE),
    [MB_UNUSED_7E] = TILE_ATTRIBUTES(TRUE, FALSE, FALSE),
    [MB_RUTA110_BRIDGE] = TILE_ATTRIBUTES(TRUE, FALSE, FALSE),
...
{
    if ((metatileBehavior == MB_WARP_OR_BRIDGE || metatileBehavior == MB_UNUSED_71 || metatileBehavior == MB_RUTA120_NORTH_BRIDGE_1 || metatileBehavior == MB_RUTA120_NORTH_BRIDGE_2)
        || (metatileBehavior == MB_RUTA120_NORTH_BRIDGE_3 || metatileBehavior == MB_RUTA120_NORTH_BRIDGE_4 || metatileBehavior == MB_UNUSED_7E || metatileBehavior == MB_RUTA110_BRIDGE))
        return TRUE;
    else
        return FALSE;
}
...
u8 MetatileBehavior_GetBridgeType(u8 metatileBehavior)
{
    ...
    result = metatileBehavior - MB_RUTA120_SOUTH_BRIDGE_1;
    if (result < 2)
        return 2;

    result = metatileBehavior - MB_RUTA120_NORTH_BRIDGE_3;
    if (result < 2)
        return 3;
