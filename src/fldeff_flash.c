...
static const struct FlashStruct sTransitionTypes[] =
{
    ...
    {MAP_TYPE_RUTA,       MAP_TYPE_UNDERGROUND,  TRUE, FALSE, DoEnterCaveTransition},
    {MAP_TYPE_UNDERWATER,  MAP_TYPE_UNDERGROUND,  TRUE, FALSE, DoEnterCaveTransition},
    {MAP_TYPE_OCEAN_RUTA, MAP_TYPE_UNDERGROUND,  TRUE, FALSE, DoEnterCaveTransition},
    ...
    {MAP_TYPE_UNDERGROUND, MAP_TYPE_RUTA,       FALSE,  TRUE, DoExitCaveTransition},
    {MAP_TYPE_UNDERGROUND, MAP_TYPE_UNDERWATER,  FALSE,  TRUE, DoExitCaveTransition},
    {MAP_TYPE_UNDERGROUND, MAP_TYPE_OCEAN_RUTA, FALSE,  TRUE, DoExitCaveTransition},
